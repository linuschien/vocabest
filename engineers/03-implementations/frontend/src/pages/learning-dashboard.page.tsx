...
export default function LearningDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (progresses && progresses.length > 0) {
      ...
      // Only update the fallback after we have the real user target (avoid premature 10 default)
      store.set('/data/todayProgress', { answeredQuestions: current?.answeredQuestions ?? 0, targetQuestions: userDailyTarget });
    }
